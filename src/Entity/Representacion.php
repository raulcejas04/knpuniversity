...
class Representacion
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity=PersonaFisica::class, inversedBy="representaciones")
     * @ORM\JoinColumn(nullable=false)
     */
    private $personaFisica;

    /**
     * @ORM\ManyToOne(targetEntity=PersonaJuridica::class, inversedBy="representaciones")
     * @ORM\JoinColumn(nullable=false)
     */
